                 ...
                 <form method="POST" id="edit-category-form" action="update-item-category">
                     ...
                     <div class="row">
                         <div class="col-md-6">
                             <div class="form-group">
                                 <label>Category ID</label>
                                 <input class="form-control form-control-sm" id="edit_category_id" name="edit_category_id"
                         ...
                         <div class="col-md-6">
                             <div class="form-group">
                                 <label>Category Code <span class="text-danger">*</span></label>
                                 <input name="edit_category_code" id="edit_category_code" class="form-control form-control-sm" type="text"
                                     placeholder="Category Code">
                             </div>
                         </div>
                     </div>
                     <div class="row">
                         <div class="col-md-12">
                             <div class="form-group">
                                 <label>Description <span class="text-danger">*</span></label>
                                 <textarea name="edit_category_description" class="form-control form-control-sm"
                                     type="text" id="edit_category_description" placeholder="Category Description"></textarea>
                             </div>
                             <div class="form-group">
                                 <label>Status <span class="text-danger">*</span></label>
                                 <select name="edit_category_status" id="edit_category_status" class="form-control form-control-sm">
                                    <option selected disabled>Select Category Status...</option>
                                     <option value="Active">Active</option>
                                     <option value="InActive">InActive</option>
                                 </select>
