...
<main class="page-content">
                            ...
                            <tbody>
                                @foreach ($reorder_items as $key => $item)
                                    <tr>
                                        ...
                                        <td id="reorder_level">{{ $item->new_soh }}</td>
                                        <td id="reorder_level">{{ date('d-m-Y h:m:s A', strtotime($item->created_at)) }}</td>
    ...
    <div class="modal fade bd-example-modal-lg" id="edit_category" data-keyboard="false" data-backdrop="static"
                    ...
                    <form method="POST" id="edit-category-form" action="update-item-category">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Category Code <span class="text-danger">*</span></label>
                                    <input name="category_code" id="edit_category_code"
                                        class="form-control form-control-sm" type="text" placeholder="Category Code">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Description <span class="text-danger">*</span></label>
                                    <textarea name="category_description" class="form-control form-control-sm"
                                        type="text" id="edit_category_description"
                                        placeholder="Category Description"></textarea>
                                </div>
                                <div class="form-group">
                                    <label>Status <span class="text-danger">*</span></label>
                                    <select name="category_status" id="edit_category_status"
